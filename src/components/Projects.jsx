  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-4xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <button
          ...
          aria-label="Close"
          onClick={onClose}
          className="absolute top-4 right-4 z-20 p-2 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-red-500 hover:text-white transition-all"
        >
          <HiX size={22} />
        </button>
        ...
        <div className="overflow-y-auto">
          {/* Hero image */}
          <div className="h-56 md:h-80 w-full overflow-hidden relative shrink-0">
            ...
            <div className="absolute bottom-4 md:bottom-6 left-4 md:left-8 z-20 pr-14">
              <h2 className="text-xl md:text-4xl font-bold text-white mb-2 leading-tight">{project.title}</h2>
          ...
          <div className="p-6 md:p-10">
            <h3 className="text-lg font-bold mb-3 text-indigo-500">Project Overview</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                {project.github ? (
                  ...
                  <p className="text-slate-500 text-sm">No public link available.</p>
                )}
              </div>
            </div>
          </div>
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            ...
            >
              <div className="h-56 bg-gradient-to-br from-indigo-600/10 to-cyan-500/10 relative overflow-hidden">
                {project.image ? (
                  <img
                    src={project.image}
                    alt={project.title}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-2xl font-bold text-indigo-500 opacity-20">{project.title}</span>
                  </div>
                )}
              ...
              <div className="p-6 md:p-8">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-indigo-500 transition-colors line-clamp-2">
                  {project.title}
                </h3>
      ...
      {/* Modal – rendered with AnimatePresence for smooth enter/exit */}
      <AnimatePresence>
        {selectedProject && (
          <Modal
